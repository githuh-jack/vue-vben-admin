...
import { getThoughtAdminList } from '#/api/biz';

defineOptions({ name: 'BizThought' });

const dataList = shallowRef<BizAdminApi.Thought[]>([]);
const loading = ref(false);
const total = ref(0);
const detailVisible = ref(false);
const detailData = shallowRef<BizAdminApi.Thought>({});
...
const columns = [
  ...
  { title: '类型', dataIndex: 'thoughtType', key: 'thoughtType', width: 100 },
...
function viewDetail(record: BizAdminApi.Thought) {
  ...
  <Page>
    ...
    >
      <div class="space-y-2">
        ...
        <p><b>类型：</b>{{ detailData.thoughtType || '—' }}</p>
        <div>
          <b>正文：</b>
